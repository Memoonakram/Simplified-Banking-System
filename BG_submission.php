...
$transferable = '';$expiryDate = '';$amount = '';$currency = '';$is_edit = false;$message = "";

$query = "SELECT * FROM bank_guarantee_pg1 WHERE user_id = ? ORDER BY created_at desc";
$stmt = $conn->prepare($query);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt->bind_param("i", $bank_guarantee_pg1_id);
    if($stmt->execute()){
        unset($_SESSION['bank_guarantee_pg1']);
        header("Location: BGpg1.php");
        echo "form submitted";
    }
    else
...
<html>
  ...
  <span>Sign Out</span>
            ...
            <div class="text-red-600 mb-4">
                This data is collected for the application “Bank Guarantee”.
            </div>
            </div>
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between mb-2">
          ...
          <div class="flex items-center text-red-600">
            <a href="BGpg1.php" class="flex items-center text-red-600">
      ...
      <div>
        <div class="flex items-center justify-between mb-2">
          ...
          <div class="flex items-center text-red-600">
            <a href="BGpg2.php" class="flex items-center text-red-600">
                <span class="mr-1">Edit</span>
                <i class="fas fa-pencil-alt"></i>
            </a>
          </div>

...
$query = "SELECT * FROM pof_pg1 WHERE user_id = ? ORDER BY created_at desc";
$stmt = $conn->prepare($query);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $sql = "UPDATE pof_pg1 SET isSubmitted = TRUE WHERE id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("i", $pof_pg1_id);
    if($stmt->execute()){
        unset($_SESSION['pof_pg1_id']);
        header("Location: pof.php");
        echo "form submitted";
    }
    else
...
<html>
  ...
  <span>Sign Out</span>
            ...
            <div class="text-red-600 mb-4">
                This data is collected for the application “pof Aval”.
            </div>
            </div>
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between mb-2">
          ...
          <div class="flex items-center text-red-600">
            <a href="pof.php" class="flex items-center text-red-600">
      ...
      <div>
        <div class="flex items-center justify-between mb-2">
          ...
          <div class="flex items-center text-red-600">
            <a href="pofpg2.php" class="flex items-center text-red-600">
                <span class="mr-1">Edit</span>
                <i class="fas fa-pencil-alt"></i>
            </a>
          </div>
